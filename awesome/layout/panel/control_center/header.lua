...
local name = wibox.widget({
	{
		helpers.margin(helpers.textbox(color.lightblue, user.font .. " bold 15", user.name), 0, 0, 4, 0),
		helpers.margin(helpers.textbox(color.mid_light, user.font .. " bold 13", user.host), 0, 0, 0, 4),
