...
brightness_slider:connect_signal("property::value", function(slider)
	...
	awful.spawn.easy_async("brightnessctl set " .. brightness_level .. "%", function() end)
end)

local icon = helpers.margin(helpers.textbox(color.orange, "Ubuntu Nerd Font bold 30", "󰃠"), 0, 15, 5, 5)
